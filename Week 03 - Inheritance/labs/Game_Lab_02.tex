...
\begin{document}
	...
	\begin{task}{Placing Relics}{placing relics}
		...
		\begin{itemize}
			\item You can use C\#'s \texttt{random} module and all relevant functions it offers for randomly generating numbers.
			...
			\item Choose an appropriate representation for your relics in terms of C\# data structures! Bear in mind that in subsequent tasks you will need to frequently check whether a relic is in a certain cell or not!
		\end{itemize}
